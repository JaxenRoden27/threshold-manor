...
export const EXPLORATION_TILES: TileTemplate[] = [
  { id: "dusty-parlor", name: "Dusty Parlor", pool: "ground", allowedFloors: ["ground"], doors: makeDoors(true, false, true, true), weight: 1, symbol: "event" },
  { id: "creaking-hall", name: "Creaking Hall", pool: "ground", allowedFloors: ["ground"], doors: makeDoors(true, true, false, true), weight: 1, symbol: "event" },
  { id: "servants-pantry", name: "Servants' Pantry", pool: "ground", allowedFloors: ["ground"], doors: makeDoors(false, true, true, false), weight: 1, symbol: "item" },
  { id: "coat-room", name: "Coat Room", pool: "ground", allowedFloors: ["ground"], doors: makeDoors(true, false, false, true), weight: 1, symbol: "item" },
  { id: "music-room", name: "Music Room", pool: "ground", allowedFloors: ["ground"], doors: makeDoors(false, true, true, true), weight: 1, symbol: "omen" },
  ...
  { id: "moonlit-balcony", name: "Moonlit Balcony", pool: "upper", allowedFloors: ["upper"], doors: makeDoors(true, true, false, false), weight: 1, symbol: "omen" },
  { id: "guest-bedroom", name: "Guest Bedroom", pool: "upper", allowedFloors: ["upper"], doors: makeDoors(true, false, true, true), weight: 1, symbol: "event" },
  { id: "nursery", name: "Nursery", pool: "upper", allowedFloors: ["upper"], doors: makeDoors(false, true, true, false), weight: 1, symbol: "omen" },
  { id: "attic-landing", name: "Attic Landing", pool: "upper", allowedFloors: ["upper"], doors: makeDoors(true, true, true, false), weight: 1, symbol: "none" },
  { id: "portrait-gallery", name: "Portrait Gallery", pool: "upper", allowedFloors: ["upper"], doors: makeDoors(false, false, true, true), weight: 1, symbol: "event", special: "gallery" },
  { id: "secret-passage", name: "Secret Passage", pool: "ground", allowedFloors: ["ground", "upper", "basement"], doors: makeDoors(true, false, true, false), weight: 1, symbol: "none", special: "secret-passage" },
  { id: "secret-stairs", name: "Secret Stairs", pool: "ground", allowedFloors: ["ground", "upper", "basement"], doors: makeDoors(false, true, false, true), weight: 1, symbol: "none", special: "secret-stairs" },
  { id: "basement-stairs", name: "Basement Stairs", pool: "basement", allowedFloors: ["basement"], doors: makeDoors(true, false, false, false), weight: 1, symbol: "none", special: "basement-stairs" },
  ...
  { id: "wine-cellar", name: "Wine Cellar", pool: "basement", allowedFloors: ["basement"], doors: makeDoors(true, false, true, true), weight: 1, symbol: "item" },
  { id: "boiler-room", name: "Boiler Room", pool: "basement", allowedFloors: ["basement"], doors: makeDoors(true, true, false, false), weight: 1, symbol: "event" },
  { id: "vault", name: "Vault", pool: "basement", allowedFloors: ["basement"], doors: makeDoors(false, true, true, false), weight: 1, symbol: "none", isLocked: true },
  { id: "flooded-tunnels", name: "Flooded Tunnels", pool: "basement", allowedFloors: ["basement"], doors: makeDoors(true, false, false, true), weight: 1, symbol: "event" },
  ...
  { id: "collapsed-passage", name: "Collapsed Passage", pool: "basement", allowedFloors: ["basement"], doors: makeDoors(true, true, false, true), weight: 1, symbol: "item" },
];
